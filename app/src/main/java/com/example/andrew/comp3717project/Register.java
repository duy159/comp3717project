...
public class Register extends Activity implements MongoAdapter {
    ...
    public void registerMongo(View v) throws JSONException {
        ...
        Mongo.put(this, collection,register.put("user",registerUser),registerQuery.put("day","tuesday"));
        Mongo.put(this, collection,register.put("user",registerUser),registerQuery.put("timestart","1400"));
        Mongo.put(this, collection,register.put("user",registerUser),registerQuery.put("timeend","2300"));
