...
public class MongoDriver {
    private static final String BASE_URL = "https://api.mongolab.com/api/1/databases/workoutbuddies/collections/";
    private static final String API_KEY = "apiKey=11h4wQ_5jg2QpLBxQ8mIM0C2HYJ54iyE ";
